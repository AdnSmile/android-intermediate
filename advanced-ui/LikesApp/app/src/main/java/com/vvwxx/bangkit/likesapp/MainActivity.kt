...
import com.vvwxx.bangkit.likesapp.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun showText() {
        ...
        val x: Float = halfOfWidth - mBounds.centerX() // buat posisi tengah
        val y = 50F
    ...
    private fun showEyes() {
        ...
        // 2 lingkaran putih mata yang menimpa lingkaran hitam
